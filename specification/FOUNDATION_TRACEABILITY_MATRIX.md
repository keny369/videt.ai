...
| Data lifecycle controls | [015 DATA_LIFECYCLE.md](015%20DATA_LIFECYCLE.md) | DLC-REQ-001 through DLC-REQ-032 | Data governance and auditability | ADR-012 | Lifecycle, retention, and single-class assignment review | Schema compatibility FF-013 and retention-assignment uniqueness check | Data, API, operations specs | Active |
| Canonical state transitions | [016 STATE_MODEL.md](016%20STATE_MODEL.md) | SM-REQ-001 through SM-REQ-010 | Deterministic lifecycle control | ADR-008 | State transition and transition-identity exclusivity test suite | Architecture test FF-002 | Domain, data, implementation specs | Active |
...
| Observability coverage | [018 OBSERVABILITY.md](018%20OBSERVABILITY.md) | OBS-REQ-001 through OBS-REQ-024 | Operability and diagnosability | ADR-011 | Telemetry coverage and terminal-signal classification review | Observability coverage FF-018 | All downstream specs | Active |
