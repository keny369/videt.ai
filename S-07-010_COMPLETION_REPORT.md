...
| --- | --- |
| `spec/acceptance/wf005_document_ingestion_spec.rb` | 22 |
...
`automation/lib/autonomous_build/s07_010_mutation_set.rb`. **22 mutations, 22 killed**, 0 survived, 0
...
| Gate | Result |
| --- | --- |
| `bundle exec rspec` | `2575 examples, 0 failures` |
...
| Mutation ledger | 22 definitions, 22 killed, 0 survived, 0 broken |
