...
```f1-evidence
candidate_range: 780b1a4..a09faa9
...
| Candidate | `780b1a4..a09faa9` |
| Files in range | 22, every one under a declared path; excluded set EMPTY |
...
| --- | --- |
| `spec/acceptance/wf005_document_ingestion_spec.rb` | 21 |
...
`automation/lib/autonomous_build/s07_010_mutation_set.rb`. **21 mutations, 21 killed**, 0 survived, 0
...
| Gate | Result |
| --- | --- |
| `bundle exec rspec` | `2574 examples, 0 failures` |
...
| Mutation ledger | 21 definitions, 21 killed, 0 survived, 0 broken |
...
The independent ADR-026 five-lens review over `780b1a4..a09faa9` — contract, security and tenancy,
