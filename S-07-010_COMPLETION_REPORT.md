...
| Gate | Result |
| --- | --- |
| `bundle exec rspec` | `2703 examples, 0 failures` (2584 at this tranche; +29 from the registration-access transport work, then +61 from the WF-003 verification surface, the crawl-detail screen and the two outbound-transport defects, and +29 from the WF-006 evaluation input gate, all of which followed it) |
