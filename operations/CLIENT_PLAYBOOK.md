...
5. **The one objection that kills sales — handle it out loud, before they raise it.** "Oh, that's AEO / SEO — I've already got a guy who does that." Never answer "no it isn't"; you lose by arguing taxonomy. Concede the adjacency and take the higher ground: *"That's the fixing half, and yeah, we end up there. But everyone selling AEO is doing surgery without an X-ray — nobody checked what the machines actually say about you first, and nobody goes back afterwards to prove it changed. That's my bit. The fixes come out of the evidence, not out of a template."* Short version: **"AEO is the treatment. I'm the diagnosis — and the proof it worked."** If they already pay someone, ask: *"Fair enough — what did they show you it was like before they started, and what does it look like now?"* Almost nobody can answer; that gap is the sale. Full kit: `branding/008 EXPLAINING_VIDET.md`.
