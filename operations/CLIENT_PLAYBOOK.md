...
5. **The one objection that kills sales, handled out loud before they raise it.** "Oh, that's AEO / SEO, I've already got a guy." Never answer "no it isn't"; you lose by arguing taxonomy, and you sound like you're attacking their supplier. Concede, then reframe with the three arguments that actually land (full scripts: `branding/008 EXPLAINING_VIDET.md`):
   - **Structure:** "It's a three-step loop: measure, fix, measure again. That work sits inside step two, and we sell it too. But of the ten kinds of fix we use, content and markup is about three."
   - **Most of what's broken isn't on your website:** "When a machine answers a question about you, it's mostly repeating what other people's pages say. Your maps listing, your ABN record, an old directory entry, a licence register. Six surfaces feed that answer and your website is one of them."
   - **The scoreboard:** "What did they show you it looked like before they started, and what does it look like now?" Almost nobody can answer. Every other line in their P&L has a before and after; this one doesn't.
   - **Then remove the confrontation, which is what closes it:** "I'm not replacing your guy. Keep him. I'm the diagnostic that tells him where to aim, and the scoreboard that tells you whether it worked. If it turns out he's already got you covered, I'll show you that and you keep your money."
   - **Trades version, one breath:** "Your bloke's a good mechanic. But nobody's put it on the diagnostic, so he's replacing parts on a hunch, and nobody's road-tested it afterwards. That's my job."
6. **Objections and no-sales get logged** same day in Appendix H. Free-pilot requests are refused — "'we'd love to try it free' is a no with flattery" (Appendix L, the forbidden list — reread it whenever tempted).
