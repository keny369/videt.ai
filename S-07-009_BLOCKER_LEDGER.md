...
| **A15-3** | Five public readers of `AuthorityAttestation` have no caller anywhere — two added by D7, three predating it — D1's rule inside D1's own tranche. (Round 15 recorded "four ... added by D7"; round 16 measured it and round 17 found this row still uncorrected.) | CLOSED — all five deleted |
